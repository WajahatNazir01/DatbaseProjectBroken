...
INSERT INTO room_types (type_name, description, per_day_charges) VALUES
('General', 'General admission room', 2000.00),
('Emergency', 'Emergency room', 3000.00),
('ICU', 'Intensive Care Unit', 8000.00),
('Private', 'Private room', 5000.00);
...
CREATE TABLE discharges (
    ...
    CONSTRAINT CHK_discharge_after_admission_date CHECK (discharge_date >= admission_date)
);
GO
...
GO
select * from vw_minimal_medical_report


-- 1. Check what status values exist in appointments
SELECT 
    status_id,
